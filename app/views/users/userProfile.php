        ...
        <div class="container-fluid d-flex align-items-center">
            <div class="row">
                <div class="col-lg-7 col-md-10">
                    ...
                    <p class="text-white mt-0 mb-5">Welcome to 'The Grand Maksuda'. This is your profile page. You can see your personal information and edit them if you like.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card card-profile shadow">
                    ...
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div>
                                <i class="ni education_hat mr-2"></i>The Grand Maksuda
                            </div>
